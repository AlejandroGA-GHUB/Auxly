...
To update, download the new release from this repo and copy it over your
bot folder. Your data carries over untouched: `.env` (your token),
`auxly.db` (profiles and playlists), and `audio_files/` are yours and are
